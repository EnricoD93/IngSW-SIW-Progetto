	...
	public void createDatabase() {
		...
		try {
			...
			String create = "create table corsodilaurea(\"codice\" int primary key,nome VARCHAR(255));"
					...
					+ "create table corso (\"codice\" bigint primary key, nome VARCHAR(255),anno int,descrizione VARCHAR(255),requisiti VARCHAR(255),giorni VARCHAR(255),ore_lezioni int,ore_esercitazioni int,materiale VARCHAR(255),\"docente\" CHARACTER(8) REFERENCES utente(\"matricola\"),corsodilaurea bigint REFERENCES corsodilaurea(\"codice\"));"
					+ "create table aula(\"id\" VARCHAR(255) primary key,posti int,\"codice\" bigint REFERENCES corsodilaurea(\"codice\"));"
					+ "create table messaggio(data DATE primary key,ora int,testo VARCHAR(255),matricola_mitt CHARACTER(8) REFERENCES utente(\"matricola\"),matricola_dest CHARACTER(8) REFERENCES utente(\"matricola\"));"
					...
					+ "create table iscritto(\"codice\" bigint primary key REFERENCES corso(\"codice\"), matricola CHARACTER(8) REFERENCES studente(\"matricola\"));"
