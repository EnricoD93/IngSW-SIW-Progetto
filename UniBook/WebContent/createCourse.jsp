	...
	<div class="block-header">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="wizard_with_validation" method="POST" role="application" class="wizard clearfix" novalidate="novalidate"><div class="steps clearfix"><ul role="tablist"><li role="tab" class="first current" aria-disabled="false" aria-selected="true" style="width: 33.3333%;"><a id="wizard_with_validation-t-0" href="#wizard_with_validation-h-0" aria-controls="wizard_with_validation-p-0"><span class="current-info audible">current step: </span><span class="number">1.</span> Account Information</a></li><li role="tab" class="disabled" aria-disabled="true" style="width: 33.3333%;"><a id="wizard_with_validation-t-1" href="#wizard_with_validation-h-1" aria-controls="wizard_with_validation-p-1"><span class="number">2.</span> Profile Information</a></li><li role="tab" class="disabled last" aria-disabled="true" style="width: 33.3333%;"><a id="wizard_with_validation-t-2" href="#wizard_with_validation-h-2" aria-controls="wizard_with_validation-p-2"><span class="number">3.</span> Terms &amp; Conditions - Finish</a></li></ul></div><div class="content clearfix">
                                <h3 id="wizard_with_validation-h-0" tabindex="-1" class="title current">Account Information</h3>
                                ...
                                <h3 id="wizard_with_validation-h-1" tabindex="-1" class="title">Profile Information</h3>
                                <fieldset id="wizard_with_validation-p-1" role="tabpanel" aria-labelledby="wizard_with_validation-h-1" class="body" aria-hidden="true" style="display: none;">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="surname" class="form-control" required="" aria-required="true">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="address" cols="30" rows="3" class="form-control no-resize" required="" aria-required="true"></textarea>
                                            <label class="form-label">Address*</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input min="18" type="number" name="age" class="form-control" required="" aria-required="true">
                                ...
                                <fieldset id="wizard_with_validation-p-2" role="tabpanel" aria-labelledby="wizard_with_validation-h-2" class="body" aria-hidden="true" style="display: none;">
                                    <input id="acceptTerms-2" name="acceptTerms" type="checkbox" required="" aria-required="true">
