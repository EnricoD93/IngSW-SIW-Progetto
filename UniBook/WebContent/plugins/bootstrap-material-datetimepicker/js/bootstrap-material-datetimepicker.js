(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: false, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Annulla', okText: 'Ok', clearText: 'Reset', nowText: 'Adesso', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
