...
function getOrarioLunedì() {
	...
	if (checkbox1.checked == 1) {
		...
		sect.html("<div class=\"input-group\"><span class=\"input-group-addon\"> Lunedì dalle </span> "
				+ "<div class=\"btn-group bootstrap-select show-tick\"> <select class=\"form-control show-tick\"  name=\"role\" required>"
				...
				+ "	class=\"radio-col-unibook\" checked> <label for=\"lezione_1\">Lezione</label> <input type=\"radio\" name=\"tipolezione_1\" id=\"esercitazione_1\" class=\"radio-col-unibook\">"
...
function getOrarioMartedì() {
	...
	sect.html("<div class=\"input-group\"><span class=\"input-group-addon\"> Martedì dalle </span> "
			+ "<div class=\"btn-group bootstrap-select show-tick\"> <select class=\"form-control show-tick\" tabindex=\"-98\" name=\"role\" required>"
			+ "<option value=\"08\">08:30</option> <option value=\"08\">09:30</option>	<option value=\"08\">10:30</option>	"
			+ "<option value=\"08\">11:30</option> <option value=\"08\">12:30</option>	<option value=\"08\">14:00</option>	"
			+ "<option value=\"08\">15:00</option> <option value=\"08\">16:00</option>	<option value=\"08\">17:00</option>	<option value=\"08\">18:00</option>	"
			+ " </select> </div> <span> <b> &nbsp; alle &nbsp;</b> </span> "
			...
			+ "	class=\"radio-col-unibook\" checked> <label for=\"lezione_2\">Lezione</label> <input type=\"radio\" name=\"tipolezione_2\" id=\"esercitazione_2\" class=\"radio-col-unibook\">"
...
function getOrarioMercoledì() {
	...
	if (checkbox3.checked == 1) {
		...
		sect.html("<div class=\"input-group\"><span class=\"input-group-addon\"> Mercoledì dalle </span> "
				...
				+ "	class=\"radio-col-unibook\" checked> <label for=\"lezione_3\">Lezione</label> <input type=\"radio\" name=\"tipolezione_3\" id=\"esercitazione_3\" class=\"radio-col-unibook\">"
...
function getOrarioGiovedì() {
	...
	if (checkbox4.checked == 1) {
		...
		sect.html("<div class=\"input-group\"><span class=\"input-group-addon\"> Giovedì dalle </span> "
				...
				+ "	class=\"radio-col-unibook\" checked> <label for=\"lezione_4\">Lezione</label> <input type=\"radio\" name=\"tipolezione_4\" id=\"esercitazione_4\" class=\"radio-col-unibook\">"
...
function getOrarioVenerdì() {
	...
	if (checkbox5.checked == 1) {
		...
		sect.html("<div class=\"input-group\"><span class=\"input-group-addon\"> Venerdì dalle </span> "
				...
				+ "	class=\"radio-col-unibook\" checked> <label for=\"lezione_5\">Lezione</label> <input type=\"radio\" name=\"tipolezione_5\" id=\"esercitazione_5\" class=\"radio-col-unibook\">"
...
function verificaGiorni() {
	...
	if(checkbox1==1 || checkbox2==1 || checkbox3==1 || checkbox4==1 || checkbox5==1){
		$('#creacorso').click();
	}else{
		swal(
				"Non hai selezionato il giorno in cui tenere lezione.",
				"Devi selezionare almeno un giorno in cui tenere la lezione","error");
	}
};
